	...
	*/
	function setEncoding($enc='gzip, deflate') {
		if (function_exists('gzdeflate')) {
			...
			//set_magic_quotes_runtime(0); // ~ deprecated, won't work with PHP 5.4.0 +
...
//		}
	...
	function parseCookie($cookie_str) {
		...
		//$data = split(';', $cookie_str); // ~ deprecated
		...
		<div class=content>
			...
			<div class=nav>
				...
				foreach($this->getOperations() as $op => $data){
				    $b .= "<li><a href='#' onclick=\"popout();popup('$op');return false;\">$op</a></li>";
				    // create hidden div
				    $b .= "<div id='$op' class='hidden'>
				    <a href='#' onclick='popout();return false;'><font color='#ffffff'>Close</font></a><br><br>";
...
class nusoap_client extends nusoap_base  {
	...
	*/
	...
	function loadWSDL() {
        ...
        /* ~ DW
        - In PHP 4, a "new" object was created as a copy of the original object, so anything you did with it had no effect on the original.
        Adding the "&" caused it to create a reference to the original so that when you made changes it changed the original object.
